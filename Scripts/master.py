...
filename = "/mlatom/home/fatemealavi/anharmonic/data/ch2o_mp2_avtz_3601.npz"
...
ani_1ccx_gelu = ml.models.model_tree_node(
    ...
    children=[ml.models.model_tree_node(
        name=f'nn{ii}',
        model=ml.models.ani(model_file=f'/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_H2CO_new_model/H2CO_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL3and5/freq_H2CO_by_TL_ani_1ccx_RemovingOutliers/ani_1ccx_gelu_TL_removingOutliers/cv{ii}.pt'),
        operator='predict') for ii in range(5)],
    operator='average'
)
...
def update_database(df_freq):
    ...
    df = pd.read_csv("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_H2CO_new_model/H2CO_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL3and5/freq_H2CO_by_TL_ani_1ccx_RemovingOutliers/freq_otherMethods.csv", sep = ",", header = 0)
    for meth in methods:    
...
with open ("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_H2CO_new_model/H2CO_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL3and5/freq_H2CO_by_TL_ani_1ccx_RemovingOutliers/anharmonicfreq.txt", "w") as file1:
