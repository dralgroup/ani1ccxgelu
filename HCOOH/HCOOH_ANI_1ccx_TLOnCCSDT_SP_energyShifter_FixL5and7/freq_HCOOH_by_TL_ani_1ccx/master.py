...
filename = "/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_HCOOH_new_model/HCOOH_ANI_1ccx_TLOnCCSDT_SP_energyShifter_FixL5and7/meuwly_db_HCOOH_CCSDT.npz"
...
ani_1ccx_gelu = ml.models.model_tree_node(
    ...
    children=[ml.models.model_tree_node(
        name=f'nn{ii}',
        model=ml.models.ani(model_file=f'/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_HCOOH_new_model/HCOOH_ANI_1ccx_TLOnCCSDT_SP_energyShifter_FixL5and7/ani1ccx_gelu_TL_CCSDT_HCOOH_byFateme/cv{ii}.pt'),
...
def update_database(df_freq):
    methods = ["exp", "mp2", "physnet_CCSD(T)-F12_NN1", "physnet_CCSD(T)-F12_NN2", "physnet_MP2_NN1", "physnet_MP2_NN2", "physnet_CCSD(T)_NN1", "physnet_CCSD(T)-NN2"]  #We need to add more methods like physnet, kreg, ... 
    df = pd.read_csv("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_HCOOH_new_model/HCOOH_ANI_1ccx_TLOnCCSDT_SP_energyShifter_FixL5and7/freq_HCOOH_by_TL_ani_1ccx/freq_otherMethods.csv", sep = ",", header = 0)
    for meth in methods:    
...
with open ("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_HCOOH_new_model/HCOOH_ANI_1ccx_TLOnCCSDT_SP_energyShifter_FixL5and7/freq_HCOOH_by_TL_ani_1ccx/harmonicfreq.txt", "w") as file1:
