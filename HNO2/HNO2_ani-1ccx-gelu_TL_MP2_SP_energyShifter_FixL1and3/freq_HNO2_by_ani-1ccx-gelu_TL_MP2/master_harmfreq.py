...
filename = "/mlatom/home/fatemealavi/anharmonic/data/hono_mp2_avtz_6406.npz"
...
ani_1ccx_gelu = ml.models.model_tree_node(
    ...
    children=[ml.models.model_tree_node(
        name=f'nn{ii}',
        model=ml.models.ani(model_file=f'/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_HNO2_new_model/HNO2_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL1and3/ani1ccx_gelu_TL_ani1x_gelu_byFateme/cv{ii}.pt'),
...
def update_database(df_freq):
    ...
    df = pd.read_csv("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_HNO2_new_model/HNO2_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL1and3/freq_HNO2_by_TL_ani_1ccx/harmfreq_otherMethods.csv", sep = ",", header = 0)
    for meth in methods:    
...
with open ("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_HNO2_new_model/HNO2_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL1and3/freq_HNO2_by_TL_ani_1ccx/harmonicfreq.txt", "w") as file1:
