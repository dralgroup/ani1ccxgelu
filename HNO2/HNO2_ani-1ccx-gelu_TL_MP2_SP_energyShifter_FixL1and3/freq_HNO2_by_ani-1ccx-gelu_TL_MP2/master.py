...
def update_database(df_freq):
    ...
    df = pd.read_csv("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_HNO2_new_model/HNO2_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL1and3/freq_HNO2_by_TL_ani_1ccx/freq_otherMethods.csv", sep = ",", header = 0)
    for meth in methods:    
