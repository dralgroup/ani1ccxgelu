...
filename = "/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_CH3OH_new_model/CH3OH_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL1and5/meuwly_db_CH3OH_MP2.npz"
...
ani_1ccx_gelu = ml.models.model_tree_node(
    ...
    children=[ml.models.model_tree_node(
        name=f'nn{ii}',
        model=ml.models.ani(model_file=f'/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_CH3OH_new_model/CH3OH_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL3and7/ani1ccx_gelu_TL_onMP2_byFateme/cv{ii}.pt'),
...
def update_database(df_freq):
    methods = ["exp", "mp2", "physnet_MP2_NN1", "physnet_MP2_NN2", "physnet_CCSD(T)_NN1", "physnet_CCSD(T)_NN2"]  #We need to add more methods like physnet, kreg, ... 
    df = pd.read_csv("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_CH3OH_new_model/CH3OH_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL3and7/freq_CH3OH_by_TL_ani_1ccx/freq_otherMethods.csv", sep = ",", header = 0)
    for meth in methods:    
...
with open ("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_CH3OH_new_model/CH3OH_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL3and7/freq_CH3OH_by_TL_ani_1ccx/harmonicfreq.txt", "w") as file1:
