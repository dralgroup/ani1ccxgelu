...
filename = "/mlatom/home/fatemealavi/anharmonic/data/meuwly_db_CH3OH_MP2.npz"
...
def update_database(df_freq):
    ...
    df = pd.read_csv("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_CH3OH_new_model/CH3OH_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL3and7/freq_CH3OH_by_TL_ani_1ccx/harmfreq_otherMethods.csv", sep = ",", header = 0)
    for meth in methods:    
