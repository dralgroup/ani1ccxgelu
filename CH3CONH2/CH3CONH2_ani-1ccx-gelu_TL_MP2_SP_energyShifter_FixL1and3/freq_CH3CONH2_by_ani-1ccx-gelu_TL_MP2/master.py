...
filename = "/mlatom/home/fatemealavi/anharmonic/data/ch3conh2_mp2_avtz_12601.npz"
...
ani_1ccx_gelu = ml.models.model_tree_node(
    ...
    children=[ml.models.model_tree_node(
        name=f'nn{ii}',
        model=ml.models.ani(model_file=f'/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_CH3CONH2_new_model/CH3CONH2_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL1and3/ani1ccx_gelu_TL_ani1x_gelu_byFateme/cv{ii}.pt'),
...
def update_database(df_freq):
    methods = ["exp", "mp2", "physnet_MP2_NN1", "physnet_MP2_NN2"]
    df = pd.read_csv("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_CH3CONH2_new_model/CH3CONH2_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL1and3/freq_CH3CONH2_by_TL_ani_1ccx/freq_otherMethods.csv", sep = ",", header = 0)
    for meth in methods:    
...
with open ("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_CH3CONH2_new_model/CH3CONH2_ANI_1ccx_TLOnMP2_SP_energyShifter_FixL1and3/freq_CH3CONH2_by_TL_ani_1ccx/harmonicfreq.txt", "w") as file1:
