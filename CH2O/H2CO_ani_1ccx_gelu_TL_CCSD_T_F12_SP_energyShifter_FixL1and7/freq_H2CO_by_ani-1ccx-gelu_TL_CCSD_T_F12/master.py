...
ani_1ccx_gelu = ml.models.model_tree_node(
    ...
    children=[ml.models.model_tree_node(
        name=f'nn{ii}',
        model=ml.models.ani(model_file=f'/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_H2CO_new_model/H2CO_ANI_1ccx_TLOnCCSDT_F12_SP_energyShifter_FixL1and7/ani1ccx_gelu_TL_ani1x_gelu_byFateme/cv{ii}.pt'),
...
def update_database(df_freq):
    ...
    df = pd.read_csv("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_H2CO_new_model/H2CO_ANI_1ccx_TLOnCCSDT_F12_SP_energyShifter_FixL1and7/freq_H2CO_by_TL_ani_1ccx/harmfreq_otherMethods.csv", sep = ",", header = 0)
    for meth in methods:    
...
with open ("/mlatom/home/fatemealavi/anharmonic/ANI_1ccx_H2CO_new_model/H2CO_ANI_1ccx_TLOnCCSDT_F12_SP_energyShifter_FixL1and7/freq_H2CO_by_TL_ani_1ccx/harmonicfreq.txt", "w") as file1:
